// 366 daily Insight puzzles for 2024 (leap year), one per day. Replace with real puzzles as needed.
...
export const insightArchive2024: InsightPuzzle[] = Array.from({ length: 366 }, (_, i) => ({
  ...basePuzzle,
  id: `insight_2024${(i+1).toString().padStart(3, '0')}`,
}));
