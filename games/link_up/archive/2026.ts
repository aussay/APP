// 365 unique, valid, and solvable Link Up puzzles for 2026.
...
function generateLinkUpPuzzle(day: number): LinkUpPuzzle {
  ...
  return {
    id: `lu_2026${(day+1).toString().padStart(3, '0')}`,
    itemsPerGroup,
    categories,
    items,
  };
...
export const linkUpArchive2026: LinkUpPuzzle[] = Array.from({ length: 365 }, (_, i) => generateLinkUpPuzzle(i));
